              ...
              <tbody class="bg-white divide-y divide-gray-200">
                <tr v-for="serrure in filteredSerrures" :key="serrure.id" class="hover:bg-gray-50">
                  ...
                  <td class="px-3 py-4 whitespace-nowrap hidden md:table-cell">
                    <div v-if="serrure.planUrl" class="h-10 w-10 relative group">
                      <img 
                        :src="serrure.planUrl" 
                      ...
                      <button 
                        ...
                        class="absolute inset-0 bg-black bg-opacity-50 rounded-md text-white text-xs font-medium flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-200"
                        title="Voir le plan"
                      >
                        Voir
                      </button>
