<template>
  <div class="flex min-h-screen bg-gray-100">
    <!-- Menu latéral -->
    <div class="w-20 bg-white shadow-md flex flex-col items-center py-6 fixed min-h-[calc(100%-40px)] my-4 mx-4 rounded-xl">
      <!-- Logo en haut -->
      <div class="mb-8">
      ...
      <!-- Lien Home -->
      <NuxtLink to="/" class="p-2 mb-4 rounded-lg hover:bg-gray-100 flex items-center justify-center w-9 h-9" :class="{ 'bg-gray-200': $route.path === '/' }">
      ...
      <!-- Lien Serrure -->
      <NuxtLink to="/serrure" class="p-2 mb-4 rounded-lg hover:bg-gray-100 flex items-center justify-center w-9 h-9" :class="{ 'bg-gray-200': $route.path === '/serrure' }">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-5 h-5 text-gray-600">
