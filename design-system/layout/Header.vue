<template>
  <header class="header-container">
    ...
    <nav class="nav-container">
      <!-- Accueil -->
      <Tooltip text="Accueil" position="right">
        <NuxtLink 
          to="/" 
          class="nav-link" 
      ...
      <!-- Panier -->
      <Tooltip text="Mon panier" position="right">
        <NuxtLink 
          to="/panier" 
      ...
      <ClientOnly>
        <Tooltip v-if="isModerator" text="Paramètres" position="right">
          <NuxtLink 
            to="/admin/settings" 
            class="nav-link" 
    ...
    <div class="user-menu">
      ...
      <ClientOnly>
        <Tooltip v-if="isAdmin" text="Administration des utilisateurs" position="right">
          <NuxtLink 
            to="/admin/users" 
        ...
        <Tooltip v-if="isAdmin" text="Design System" position="right">
          <NuxtLink 
